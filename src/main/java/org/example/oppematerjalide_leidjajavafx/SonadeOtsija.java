...
// kui ei leitud ühtegi sobivat lõiku
        ...
        for (LoiguTulemus tulemus : tulemused) {
            ...
            if (parimad.isEmpty()) {
                throw new KasutajaViga("Sobivaid lõike ei leitud. Proovi teistsugust küsimust.");
            }
        }
    ...
    /**
     * Võtab otsitavalt sõna lõpust ära sagedasemad sõnalõpud
     * et leida "sõnatüvi"
     * @param sona mida tahame puhastada
     * @return sõnatüvi
     */
